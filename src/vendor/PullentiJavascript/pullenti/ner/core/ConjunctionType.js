...
class ConjunctionType {
    ...
    static static_constructor() {
        ...
        ConjunctionType.LET = new ConjunctionType(9, "LET");
        ConjunctionType.mapIntToEnum.put(ConjunctionType.LET.value(), ConjunctionType.LET); 
        ConjunctionType.mapStringToEnum.put(ConjunctionType.LET.m_str.toUpperCase(), ConjunctionType.LET); 
        ConjunctionType.WHEN = new ConjunctionType(10, "WHEN");
        ...
        ConjunctionType.BECAUSE = new ConjunctionType(11, "BECAUSE");
        ...
        ConjunctionType.INCLUDE = new ConjunctionType(12, "INCLUDE");
        ...
        ConjunctionType.EXCEPT = new ConjunctionType(13, "EXCEPT");
