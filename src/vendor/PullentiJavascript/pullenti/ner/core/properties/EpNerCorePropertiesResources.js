...
class EpNerCorePropertiesResources {
...
EpNerCorePropertiesResources.names = ["MoneyEN.csv", "MoneyUA.csv", "Money.csv", "unknown.png"]; 

module.exports = EpNerCorePropertiesResources