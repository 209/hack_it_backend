...
class OrgProfile {
    ...
    static static_constructor() {
        ...
        OrgProfile.ART = new OrgProfile(19, "ART");
        OrgProfile.mapIntToEnum.put(OrgProfile.ART.value(), OrgProfile.ART); 
        OrgProfile.mapStringToEnum.put(OrgProfile.ART.m_str.toUpperCase(), OrgProfile.ART); 
