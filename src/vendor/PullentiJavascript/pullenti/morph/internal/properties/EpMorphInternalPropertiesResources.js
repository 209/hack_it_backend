...
class EpMorphInternalPropertiesResources {
...
EpMorphInternalPropertiesResources.names = ["m_ru.dat", "m_en.dat", "m_ua.dat"]; 

module.exports = EpMorphInternalPropertiesResources